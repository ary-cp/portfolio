      ...
      <div className="relative z-10">
        ...
        <nav className="max-w-6xl mx-auto px-6 py-8 flex items-center justify-between sticky top-0 z-40 bg-black/50 backdrop-blur-xl border-b border-white/5">
          ...
          <a 
            ...
            className="px-6 py-2.5 rounded-full border border-white/10 hover:bg-white hover:text-black transition-all active:scale-95 text-sm font-medium text-white"
          >
            Book a Call
          </a>
        </nav>
